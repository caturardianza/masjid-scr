					  ...
					  <ul class="nav nav-stacked">
						...
						<li>
							<a class="row">
								...
								<div class="col-xs-7"><span class="badge bg-aqua">Juli 2023</span></div>
							</a>
						</li>
						<li>
							<a class="row">
								<div class="col-xs-5" style="text-align:right">Owner</div>
								<div class="col-xs-7">Catur Ardianza</div>
							</a>
						</li>
						<li>
							<a class="row">
								<div class="col-xs-5" style="text-align:right">Display design</div>
								<div class="col-xs-7">Ardianz Project</div>
							</a>
						</li>
						<li>
							<a class="row">
